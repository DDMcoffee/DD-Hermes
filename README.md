...
- 当前 phase-2 主线：`dd-hermes-quality-seat-escalation-rules-v1`
- 最近归档的 phase-2 proof：`dd-hermes-independent-quality-seat-v1`
- 对应 archive：`openspec/archive/dd-hermes-independent-quality-seat-v1.md`
