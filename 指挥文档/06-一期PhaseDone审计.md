...
current_gap_1: phase-2 的 anchor-governance 主线已经归档；后续需要决定新的 phase-2 主线任务是什么。
...
- 一期已经能用
- phase-2 主线已经定义
- `dd-hermes-anchor-governance-v1` 现在已经有正式 task 工件、execution closeout 和 archive
...
下一条唯一主线已经由 `dd-hermes-anchor-governance-v1` 走完并归档。

当前正确表述是：

- 一期已经收口。
- 下一步不是继续补一期，而是决定 phase-2 的下一条主线任务是什么。
- 重点仍然不是“多开几个 agent”，而是让两个恒定锚点成为任务推进的硬约束。
- 当前这条主线已经完成并归档，`dispatch-create` / `thread-switch-gate` 只作为历史能力保留。
