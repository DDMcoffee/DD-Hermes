...
Expert expert-a owns a reserved execution slot for the separate experiment task dd-hermes-s5-2expert-20260416 inside an isolated worktree. This does not count toward the current endpoint/schema main-task finish line.
